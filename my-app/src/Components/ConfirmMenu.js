        ...
        <div >
            <Modal className='submenu' centered show={obj.state} onHide={handleClose}>
                ...
                <Modal.Footer style={{ justifyContent: "space-between" }}>
                    <button className='btn btn-outline-danger' style={{ width: "25%" }} onClick={handleClose}>Hủy</button>
                    <button className='btn btn-outline-primary mx-2' style={{ width: "25%" }} onClick={() => { handleClose(); obj.act() }}>Đồng ý</button>
                </Modal.Footer>
            </Modal>
        </div>
    );
