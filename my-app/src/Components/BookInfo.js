    ...
    return (
        <div>
            ...
            <form className="form book-info">
                <div style={{ width: "100%" }}>
                    ...
                    <div className=" book-text " style={{ width: "100%" }}>
                        ...
                        <textarea readOnly className="form-control" id="description" value={book.description || ''} ></textarea>
                    </div>
                    <div className="one-line">
                        <div className=" book-text ">
            ...
            <form>
                ...
                <button onClick={purchase} type="button" className="btn btn-outline-danger" > Đặt mua</button>
            </form>
            <br />
            <div className="form">
